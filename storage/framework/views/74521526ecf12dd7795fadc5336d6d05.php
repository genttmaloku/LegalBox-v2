...
<body>
    ...
    <div class="h-screen md:flex ">
        ...
        <div class="flex md:w-1/2 justify-center py-10 px-10 items-center">
            ...
            <form  class=" lg:w-1/2" id="registerForm" >
                ...
                <p class="text-sm font-normal text-white mb-7">Already registered? <a href="<?php echo e(URL('login')); ?>" class="underline text-cyan-600 hover:text-cyan-400 duration-300"> Log in here.</a> </p>
    ...
    document.getElementById('registerForm').addEventListener('submit', function (e) {
        ...
        fetch("<?php echo e(route('lawyer.register')); ?>", {
            method: "POST",
            body: formData,
        })
        .then(response => {
...
</html><?php /**PATH C:\xampp1\htdocs\LegalBox\resources\views/lawyerregister.blade.php ENDPATH**/ ?>