...
<body>
    <div class="h-screen md:flex ">
        <div
            ...
            <div>
                <div class="flex">
                <img src="<?php echo e(URL('images/elaw.png')); ?>" alt="" class="h-20">
                <img src="<?php echo e(URL('images/legalboxteal.png')); ?>" alt="" class="h-20">
            </div>
               <p class="text-white mt-1 text-wrap">Register as a Firm to manage your clients and schedule your meetings.</p>
                <a href="<?php echo e(URL('home')); ?>"><p class="underline">Back to Home Page</p></a>
            </div>
        ...
        <div class="flex md:w-1/2 justify-center py-10 px-10 items-center">
            <form class="lg:w-1/2" id="registerForm">
                ...
                <h1 class="text-white font-bold text-2xl mb-1">Register as a <span class="text-cyan-400">Firm</span> </h1> 
                 <p class="text-sm font-normal text-white mb-7">Already registered? <a href="<?php echo e(URL('firmlogin')); ?>" class="underline text-cyan-600 hover:text-cyan-400 duration-300"> Log in here.</a> </p>
            ...
            <script>
                document.getElementById('registerForm').addEventListener('submit', function (e) {
                    ...
                    fetch("<?php echo e(route('lawfirm.register')); ?>", {
                        method: "POST",
                        body: formData,
                    })
                    ...
                    .then(data => {
                        ...
                        if (data.token) {
                            ...
                            window.location.href = "<?php echo e(URL('firmlogin')); ?>";
                        } else {
...
</html><?php /**PATH C:\xampp\htdocs\LegalBox\resources\views/firmregister.blade.php ENDPATH**/ ?>