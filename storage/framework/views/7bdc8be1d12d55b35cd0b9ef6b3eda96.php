                          ...
                          <div class="joinus mt-20">
                            ...
                            <div class="mt-6">
                              <div class="rounded-md shadow">
                                <a href="" class="flex items-center justify-center w-full px-5 py-3 text-base font-medium text-white bg-gray-800 border border-transparent transition duration-300 ease-in-out rounded-md hover:bg-gray-900" target="_blank">Register</a>
                              </div>
                            </div>
...
</html><?php /**PATH C:\xampp\htdocs\LegalBox\resources\views/loginrole.blade.php ENDPATH**/ ?>