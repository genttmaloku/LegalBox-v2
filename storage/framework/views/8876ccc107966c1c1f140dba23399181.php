            ...
            <div class="hero-content flex-col lg:flex-row text-white">
              ...
              <div class="pr-10">
                ...
                <p class="py-6">Sign up to manage your legal procedures and clients using LegalBox now. It's free!</p>
                  <a href="<?php echo e(URL('register')); ?>"> <button class="btn text-white bg-cyan-400">SIGN UP</button></a>
              </div>
          </div>
        </div>
      </div>
...
</html><?php /**PATH C:\xampp1\htdocs\LegalBox\resources\views/home.blade.php ENDPATH**/ ?>